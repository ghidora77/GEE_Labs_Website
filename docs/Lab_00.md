...
```{r code-editor, fig.cap='A view of the google earth engine code editor', out.width='80%', fig.asp=.75, echo = FALSE}
knitr::include_graphics("./im/im_01_01.png")
```
...
```{r im2,  out.width='50%', fig.asp=.75, echo = FALSE, fig.align = "center"}
knitr::include_graphics("./im/im_01_02.png")
```
...
```{r im3,  out.width='50%', fig.asp=.75, echo = FALSE, fig.align = "center"}
knitr::include_graphics("./im/im_01_03.png")
...
```{r im4,  out.width='50%', fig.asp=.75, echo = FALSE, fig.align = "center"}
knitr::include_graphics("./im/im_01_04.png")
```
